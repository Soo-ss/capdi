    ...
    return  (
        <Layout>
                ...
                <div className="MMSE_input">
                    ...
                    <div className="answer_btn">
                        <label><input type="radio" name="year" value="60"/>60~69세</label>
                        <label><input type="radio" name="year" value="70"/>70~74세</label>
                        <label><input type="radio" name="year" value="75"/>75~79세</label>
                        <label><input type="radio" name="year" value="80"/>80세 이상</label>
                    </div>
                </div>

                <div className="MMSE_input">
                    <p className="input_question last_question">Q. 검사자의 학력을 선택해주세요.</p>
                    <div className="answer_btn">
                        <label><input type="radio" name="education" value="0"/>0-3년</label>
                        <label><input type="radio" name="education" value="4"/>4-6년</label>
                        <label><input type="radio" name="education" value="7"/>7-12년</label>
